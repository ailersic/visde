...
from experiments.forced_burgers_1d.train_nsde import create_nsde, NSDEConfig, TestNSDE
...
OUT_DIR = os.path.join(CURR_DIR, "postproc_nsde")
...
def main(train_val_test: str = "test"):
    ...
    model = TestNSDE.load_from_checkpoint("experiments/forced_burgers_1d/logs_nsde/version_ref_200_ll_2/checkpoints/epoch=49-step=80000.ckpt",
                                                 config=nsdeconfig,
                                                 encoder=encoder,
                                                 decoder=decoder,
                                                 drift=drift,
